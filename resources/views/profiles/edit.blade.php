                ...
                <div class="col-8 offset-2">
                    ...
                    <div class="form-group row">
                        ...
                        <input id="title" type="title" class="form-control @error('title') is-invalid @enderror"
                               name="title" value="{{ old('title') ?? Auth::user()->profile->title }}" required autocomplete="title">
                    ...
                    <div class="form-group row">
                        ...
                        <input id="description" type="description" class="form-control @error('description') is-invalid @enderror"
                               name="description" value="{{ old('description') ?? Auth::user()->profile->description }}" required autocomplete="description">
                    ...
                    <div class="form-group row">
                        ...
                        <input id="url" type="url" class="form-control @error('url') is-invalid @enderror"
                               name="url" value="{{ old('url') ?? Auth::user()->profile->url }}" required autocomplete="url">
